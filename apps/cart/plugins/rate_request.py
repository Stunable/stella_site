...
def get_rate(**kwargs):
    ...
    # Shipper's address
    rate_request.RequestedShipment.Shipper.Address.PostalCode = shipper_zipcode
    ...
    # Recipient address
    rate_request.RequestedShipment.Recipient.Address.PostalCode = recipient_zipcode
