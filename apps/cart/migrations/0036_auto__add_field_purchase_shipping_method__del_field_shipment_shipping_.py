...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Shipment.shipping_method'
        db.delete_column('cart_shipment', 'shipping_method_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Shipment.shipping_method'
        db.add_column('cart_shipment', 'shipping_method',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.ShippingType'], null=True, blank=True),
                      keep_default=False)
