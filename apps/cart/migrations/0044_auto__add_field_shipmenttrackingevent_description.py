...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShipmentTrackingEvent.description'
        db.add_column('cart_shipmenttrackingevent', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShipmentTrackingEvent.description'
        db.delete_column('cart_shipmenttrackingevent', 'description')
