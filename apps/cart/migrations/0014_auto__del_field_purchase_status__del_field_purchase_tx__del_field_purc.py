...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Purchase.tx'
        db.delete_column('cart_purchase', 'tx')

        # Deleting field 'Purchase.purchased_at'
        db.delete_column('cart_purchase', 'purchased_at')

        # Adding field 'Purchase.transaction'
        db.add_column('cart_purchase', 'transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stunable_wepay.WePayTransaction']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('cart_purchase', 'status',
                      self.gf('django.db.models.fields.CharField')(default='ordered', max_length=250),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Purchase.tx'
        raise RuntimeError("Cannot reverse this migration. 'Purchase.tx' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Purchase.purchased_at'
        raise RuntimeError("Cannot reverse this migration. 'Purchase.purchased_at' and its values cannot be restored.")
        # Deleting field 'Purchase.transaction'
        db.delete_column('cart_purchase', 'transaction_id')
    ...
    models = {
        ...
        'cart.cart': {
            ...
            'checkout_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
