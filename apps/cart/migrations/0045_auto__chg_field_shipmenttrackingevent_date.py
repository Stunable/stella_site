...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShipmentTrackingEvent.date'
        db.alter_column('cart_shipmenttrackingevent', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ShipmentTrackingEvent.date'
        raise RuntimeError("Cannot reverse this migration. 'ShipmentTrackingEvent.date' and its values cannot be restored.")
