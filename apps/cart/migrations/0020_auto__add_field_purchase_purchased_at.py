...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.purchased_at'
        db.add_column('cart_purchase', 'purchased_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 10, 16, 0, 0), blank=True),
                      keep_default=False)
