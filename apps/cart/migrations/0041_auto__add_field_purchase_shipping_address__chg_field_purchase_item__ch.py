...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.shipping_address'
        db.add_column('cart_purchase', 'shipping_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ShippingInfo'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Purchase.item'
        db.alter_column('cart_purchase', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kart.KartItem']))

        # Changing field 'Checkout.cart'
        db.alter_column('cart_checkout', 'cart_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kart.Kart']))

    def backwards(self, orm):
        # Deleting field 'Purchase.shipping_address'
        db.delete_column('cart_purchase', 'shipping_address_id')


        # Changing field 'Purchase.item'
        db.alter_column('cart_purchase', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.Item']))

        # Changing field 'Checkout.cart'
        db.alter_column('cart_checkout', 'cart_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cart.Cart']))
