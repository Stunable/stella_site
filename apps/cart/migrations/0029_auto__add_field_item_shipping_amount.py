...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.shipping_amount'
        db.add_column('cart_item', 'shipping_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.shipping_amount'
        db.delete_column('cart_item', 'shipping_amount')
    ...
    models = {
        ...
        'cart.item': {
            ...
            'sales_tax_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '2', 'blank': 'True'}),
            'shipping_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '2', 'blank': 'True'}),
            'shipping_label': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cart.ShippingLabel']", 'null': 'True'}),
            'shipping_method': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.ShippingType']", 'null': 'True', 'blank': 'True'}),
