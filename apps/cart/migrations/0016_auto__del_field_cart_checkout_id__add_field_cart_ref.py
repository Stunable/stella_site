...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cart.checkout_id'
        db.delete_column('cart_cart', 'checkout_id')

        # Adding field 'Cart.ref'
        db.add_column('cart_cart', 'ref',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cart.checkout_id'
        db.add_column('cart_cart', 'checkout_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Cart.ref'
        db.delete_column('cart_cart', 'ref')
