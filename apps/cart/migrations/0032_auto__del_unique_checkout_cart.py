...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Checkout', fields ['cart']
        db.delete_unique('cart_checkout', ['cart_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Checkout', fields ['cart']
        db.create_unique('cart_checkout', ['cart_id'])
