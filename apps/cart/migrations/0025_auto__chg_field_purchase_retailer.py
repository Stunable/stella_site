...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Purchase.retailer'
        db.alter_column('cart_purchase', 'retailer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Purchase.retailer'
        raise RuntimeError("Cannot reverse this migration. 'Purchase.retailer' and its values cannot be restored.")
    ...
    models = {
        ...
        'cart.purchase': {
            ...
            'ref': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'retailer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sold_goods'", 'null': 'True', 'to': "orm['auth.User']"}),
            'shipping_method': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.ShippingType']", 'null': 'True', 'blank': 'True'}),
            'shipping_number': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
