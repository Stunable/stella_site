...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingLabel.tracking_number'
        db.add_column('cart_shippinglabel', 'tracking_number',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingLabel.tracking_number'
        db.delete_column('cart_shippinglabel', 'tracking_number')
