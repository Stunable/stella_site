...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cart', ['Checkout'])

        # Adding field 'Purchase.checkout'
        db.add_column('cart_purchase', 'checkout',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cart.Checkout']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Checkout'
        db.delete_table('cart_checkout')

        # Deleting field 'Purchase.checkout'
        db.delete_column('cart_purchase', 'checkout_id')
