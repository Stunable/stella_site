...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.size'
        db.alter_column('cart_item', 'size', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Item.size'
        db.alter_column('cart_item', 'size', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
