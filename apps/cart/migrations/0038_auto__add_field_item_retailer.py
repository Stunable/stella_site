...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cart_item', 'retailer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['retailers.RetailerProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.retailer'
        db.delete_column('cart_item', 'retailer_id')
