...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.shipping_method'
        db.add_column('cart_cart', 'shipping_method',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.ShippingType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.shipping_method'
        db.delete_column('cart_cart', 'shipping_method_id')
