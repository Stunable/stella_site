...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkout.purchaser'
        db.add_column('cart_checkout', 'purchaser',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='purchaser_checkout_set', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkout.purchaser'
        db.delete_column('cart_checkout', 'purchaser_id')
    ...
    models = {
        ...
        'cart.item': {
            ...
            'shipping_label': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cart.ShippingLabel']", 'null': 'True', 'blank': 'True'}),
