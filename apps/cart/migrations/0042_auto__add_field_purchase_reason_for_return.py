...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.reason_for_return'
        db.add_column('cart_purchase', 'reason_for_return',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Purchase.reason_for_return'
        db.delete_column('cart_purchase', 'reason_for_return')
    ...
    models = {
        ...
        'kart.kart': {
            ...
            'checked_out': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 24, 0, 0)'}),
