...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cart.destination_zip_code'
        db.add_column('cart_cart', 'destination_zip_code',
                      self.gf('django.db.models.fields.CharField')(default='60606', max_length=10, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cart.destination_zip_code'
        db.delete_column('cart_cart', 'destination_zip_code')
