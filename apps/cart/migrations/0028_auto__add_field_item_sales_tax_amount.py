...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.sales_tax_amount'
        db.add_column('cart_item', 'sales_tax_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.sales_tax_amount'
        db.delete_column('cart_item', 'sales_tax_amount')
