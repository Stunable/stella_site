...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkout.return_messages_sent'
        db.add_column('cart_checkout', 'return_messages_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Purchase.purchased_at'
        db.alter_column('cart_purchase', 'purchased_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Checkout.return_messages_sent'
        db.delete_column('cart_checkout', 'return_messages_sent')


        # Changing field 'Purchase.purchased_at'
        db.alter_column('cart_purchase', 'purchased_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        'cart.checkout': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'messages_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'return_messages_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'cart.item': {
        ...
        'cart.shipment': {
            ...
            'shipping_method': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.ShippingType']", 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'Label Created'", 'max_length': '128'}),
        ...
        'stunable_wepay.wepaytransaction': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 9, 0, 0)'}),
