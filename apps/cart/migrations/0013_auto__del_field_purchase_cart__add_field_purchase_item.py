...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Purchase.cart'
        db.delete_column('cart_purchase', 'cart_id')

        # Adding field 'Purchase.item'
        db.add_column('cart_purchase', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cart.Item']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Purchase.cart'
        raise RuntimeError("Cannot reverse this migration. 'Purchase.cart' and its values cannot be restored.")
        # Deleting field 'Purchase.item'
        db.delete_column('cart_purchase', 'item_id')
