...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkout.messages_sent'
        db.add_column('cart_checkout', 'messages_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkout.messages_sent'
        db.delete_column('cart_checkout', 'messages_sent')
