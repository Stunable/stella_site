...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flavor.description'
        db.add_column('stunable_search_flavor', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flavor.description'
        db.delete_column('stunable_search_flavor', 'description')
