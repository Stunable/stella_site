...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSearchTab.name'
        db.add_column('stunable_search_usersearchtab', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSearchTab.name'
        db.delete_column('stunable_search_usersearchtab', 'name')
