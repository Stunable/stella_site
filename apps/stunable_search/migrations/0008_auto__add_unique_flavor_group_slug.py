...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Flavor', fields ['group', 'slug']
        db.create_unique('stunable_search_flavor', ['group', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Flavor', fields ['group', 'slug']
        db.delete_unique('stunable_search_flavor', ['group', 'slug'])
    ...
    models = {
        ...
        'stunable_search.flavor': {
            ...
            'Meta': {'unique_together': "(('slug', 'group'),)", 'object_name': 'Flavor'},
        ...
        'stunable_search.usersearchtab': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'group': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
