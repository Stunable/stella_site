...
from apps.social_auth.backends import ConsumerBasedOAuth, OAuthBackend, USERNAME
from apps.social_auth.backends.exceptions import AuthCanceled
...
TWITTER_CHECK_AUTH = 'https://%s/1/account/verify_credentials.json' % TWITTER_SERVER
