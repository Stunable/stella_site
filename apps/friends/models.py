...
class JoinInvitationManager(models.Manager):
    ...
    def send_invitation(self, from_user, to_email, message, subject, email_message):
...
class JoinInvitation(models.Model):
    ...
    def accept(self, new_user):
        ...
        # notify
        if notification:
#            notification.send([self.from_user], "friends_accept", {"invitation": self, "new_user": new_user})
            friends = []
