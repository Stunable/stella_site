...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('paypal_nvp', 'transactionid',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PayPalNVP.paymentstatus'
        db.add_column('paypal_nvp', 'paymentstatus',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PayPalNVP.paymentstatus'
        db.delete_column('paypal_nvp', 'paymentstatus')
    ...
    models = {
        ...
        'pro.paypalnvp': {
            ...
            'paymentstatus': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
