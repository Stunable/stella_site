...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExternalPost.date'
        db.alter_column('news_externalpost', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'ExternalPost.date'
        db.alter_column('news_externalpost', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
