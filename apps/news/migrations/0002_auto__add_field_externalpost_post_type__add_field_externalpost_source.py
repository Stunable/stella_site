...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalPost.post_type'
        db.add_column('news_externalpost', 'post_type',
                      self.gf('django.db.models.fields.CharField')(default='news', max_length=16),
                      keep_default=False)

        # Adding field 'ExternalPost.source'
        db.add_column('news_externalpost', 'source',
                      self.gf('django.db.models.fields.CharField')(default='http://stunablenews.wordpress.com/', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalPost.post_type'
        db.delete_column('news_externalpost', 'post_type')

        # Deleting field 'ExternalPost.source'
        db.delete_column('news_externalpost', 'source')
