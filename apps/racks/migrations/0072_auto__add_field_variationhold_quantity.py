...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariationHold.quantity'
        db.add_column('racks_variationhold', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VariationHold.quantity'
        db.delete_column('racks_variationhold', 'quantity')
