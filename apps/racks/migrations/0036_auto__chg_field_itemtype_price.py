...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.price'
        db.alter_column('racks_itemtype', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ItemType.price'
        db.alter_column('racks_itemtype', 'price', self.gf('django.db.models.fields.DecimalField')(default=1000.0, max_digits=19, decimal_places=2))
