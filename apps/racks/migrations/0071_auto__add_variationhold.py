...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VariationHold'
        db.create_table('racks_variationhold', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('variation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['racks.ItemType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('racks', ['VariationHold'])


    def backwards(self, orm):
        # Deleting model 'VariationHold'
        db.delete_table('racks_variationhold')
