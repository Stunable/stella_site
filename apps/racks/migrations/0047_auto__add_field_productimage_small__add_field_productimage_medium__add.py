...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.small'
        db.add_column('racks_productimage', 'small',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductImage.medium'
        db.add_column('racks_productimage', 'medium',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductImage.large'
        db.add_column('racks_productimage', 'large',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductImage.extralarge'
        db.add_column('racks_productimage', 'extralarge',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ProductImage.image'
        db.alter_column('racks_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'ProductImage.small'
        db.delete_column('racks_productimage', 'small')

        # Deleting field 'ProductImage.medium'
        db.delete_column('racks_productimage', 'medium')

        # Deleting field 'ProductImage.large'
        db.delete_column('racks_productimage', 'large')

        # Deleting field 'ProductImage.extralarge'
        db.delete_column('racks_productimage', 'extralarge')


        # Changing field 'ProductImage.image'
        db.alter_column('racks_productimage', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
