...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rack.owner'
        db.delete_column('racks_rack', 'owner_id')

        # Adding field 'Rack.user'
        db.add_column('racks_rack', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_by_user', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Rack.anon_user_profile'
        db.add_column('racks_rack', 'anon_user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.AnonymousProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Rack.owner'
        db.add_column('racks_rack', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owner', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Rack.user'
        db.delete_column('racks_rack', 'user_id')

        # Deleting field 'Rack.anon_user_profile'
        db.delete_column('racks_rack', 'anon_user_profile_id')
