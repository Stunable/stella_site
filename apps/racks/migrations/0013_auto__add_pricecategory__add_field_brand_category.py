...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('racks_pricecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('display_value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal('racks', ['PriceCategory'])

        # Adding field 'Brand.category'
        db.add_column('racks_brand', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['racks.PriceCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PriceCategory'
        db.delete_table('racks_pricecategory')

        # Deleting field 'Brand.category'
        db.delete_column('racks_brand', 'category_id')
