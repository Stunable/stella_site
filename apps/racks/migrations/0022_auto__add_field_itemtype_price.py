...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemType.price'
        db.add_column('racks_itemtype', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=99, max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemType.price'
        db.delete_column('racks_itemtype', 'price')
