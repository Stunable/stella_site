...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemType.api_type'
        db.add_column('racks_itemtype', 'api_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='variation_api_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'ItemType.object_id'
        db.add_column('racks_itemtype', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.api_type'
        db.add_column('racks_item', 'api_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_api_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Item.object_id'
        db.add_column('racks_item', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemType.api_type'
        db.delete_column('racks_itemtype', 'api_type_id')

        # Deleting field 'ItemType.object_id'
        db.delete_column('racks_itemtype', 'object_id')

        # Deleting field 'Item.api_type'
        db.delete_column('racks_item', 'api_type_id')

        # Deleting field 'Item.object_id'
        db.delete_column('racks_item', 'object_id')
