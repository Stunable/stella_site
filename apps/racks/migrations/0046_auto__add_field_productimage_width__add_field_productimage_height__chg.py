...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('racks_productimage', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)

        # Adding field 'ProductImage.height'
        db.add_column('racks_productimage', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


        # Changing field 'Item.price_text'
        db.alter_column('racks_item', 'price_text', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):
        # Deleting field 'ProductImage.width'
        db.delete_column('racks_productimage', 'width')

        # Deleting field 'ProductImage.height'
        db.delete_column('racks_productimage', 'height')


        # Changing field 'Item.price_text'
        db.alter_column('racks_item', 'price_text', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
