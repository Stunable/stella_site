...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('racks_item', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Item.slug'
        db.alter_column('racks_item', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
