...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.inventory'
        db.alter_column('racks_itemtype', 'inventory', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ItemType.inventory'
        db.alter_column('racks_itemtype', 'inventory', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
