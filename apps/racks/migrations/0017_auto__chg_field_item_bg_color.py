...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.bg_color'
        db.alter_column('racks_item', 'bg_color', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Item.bg_color'
        db.alter_column('racks_item', 'bg_color', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
