...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemSize'
        db.create_table('racks_itemsize', (
            ...
            ('created_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('racks', ['ItemSize'])

        # Adding model 'ItemColor'
        db.create_table('racks_itemcolor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['racks.Item'])),
            ('color', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['racks.Color'])),
            ('retailer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('racks', ['ItemColor'])


    def backwards(self, orm):
        # Deleting model 'ItemSize'
        db.delete_table('racks_itemsize')

        # Deleting model 'ItemColor'
        db.delete_table('racks_itemcolor')
    ...
    models = {
        ...
        'racks.item': {
            ...
            'colors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'color_collection'", 'to': "orm['racks.Color']", 'through': "orm['racks.ItemColor']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'sizes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'size_collection'", 'to': "orm['racks.Size']", 'through': "orm['racks.ItemSize']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'tags': ('tagging.fields.TagField', [], {})
        },
        'racks.itemcolor': {
            'Meta': {'object_name': 'ItemColor'},
