...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('racks_productimage', 'path')

        # Adding field 'ProductImage.identifier'
        db.add_column('racks_productimage', 'identifier',
    ...
    def backwards(self, orm):
        ...
        db.add_column('racks_productimage', 'path',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProductImage.identifier'
        db.delete_column('racks_productimage', 'identifier')
