...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.retailer'
        db.add_column('racks_productimage', 'retailer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.retailer'
        db.delete_column('racks_productimage', 'retailer_id')
