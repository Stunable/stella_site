...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('racks_item', 'bg_color',
                      self.gf('django.db.models.fields.CharField')(default='white', max_length=12, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'racks.item': {
            ...
            'bg_color': ('django.db.models.fields.CharField', [], {'default': "'white'", 'max_length': '12', 'null': 'True', 'blank': 'True'}),
