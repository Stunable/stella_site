...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DailySpecial.item'
        raise RuntimeError("Cannot reverse this migration. 'DailySpecial.item' and its values cannot be restored.")
        # Deleting field 'DailySpecial.display_name'
        db.delete_column('racks_dailyspecial', 'display_name')

        # Deleting field 'DailySpecial.slug'
        db.delete_column('racks_dailyspecial', 'slug')
