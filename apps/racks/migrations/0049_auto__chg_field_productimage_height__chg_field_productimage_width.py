...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage.height'
        db.alter_column('racks_productimage', 'height', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProductImage.width'
        db.alter_column('racks_productimage', 'width', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductImage.height'
        db.alter_column('racks_productimage', 'height', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'ProductImage.width'
        db.alter_column('racks_productimage', 'width', self.gf('django.db.models.fields.IntegerField')(default=1))
