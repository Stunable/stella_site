...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage.identifier'
        db.alter_column('racks_productimage', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ProductImage.identifier'
        db.alter_column('racks_productimage', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
