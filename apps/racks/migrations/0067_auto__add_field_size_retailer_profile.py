...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Size.retailer_profile'
        db.add_column('racks_size', 'retailer_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.RetailerProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Size.retailer_profile'
        db.delete_column('racks_size', 'retailer_profile_id')
