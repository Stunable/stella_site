...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage.retailer'
        db.alter_column('racks_productimage', 'retailer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProductImage.retailer'
        raise RuntimeError("Cannot reverse this migration. 'ProductImage.retailer' and its values cannot be restored.")
