...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.custom_color_name'
        db.alter_column('racks_itemtype', 'custom_color_name', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Adding unique constraint on 'ItemType', fields ['item', 'custom_color_name', 'size']
        db.create_unique('racks_itemtype', ['item_id', 'custom_color_name', 'size_id'])

        # Adding field 'Item.is_available'
        db.add_column('racks_item', 'is_available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ItemType', fields ['item', 'custom_color_name', 'size']
        db.delete_unique('racks_itemtype', ['item_id', 'custom_color_name', 'size_id'])


        # Changing field 'ItemType.custom_color_name'
        db.alter_column('racks_itemtype', 'custom_color_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Deleting field 'Item.is_available'
        db.delete_column('racks_item', 'is_available')
