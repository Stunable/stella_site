...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemType.SKU'
        db.add_column('racks_itemtype', 'SKU',
                      self.gf('django.db.models.fields.CharField')(default='NO SKU', max_length=64),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ItemType.SKU'
        db.delete_column('racks_itemtype', 'SKU')
