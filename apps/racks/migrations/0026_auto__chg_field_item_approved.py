...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.approved'
        db.alter_column('racks_item', 'approved', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Item.approved'
        db.alter_column('racks_item', 'approved', self.gf('django.db.models.fields.BooleanField')())
