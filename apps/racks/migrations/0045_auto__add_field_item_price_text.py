...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.price_text'
        db.add_column('racks_item', 'price_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.price_text'
        db.delete_column('racks_item', 'price_text')
    ...
    models = {
        ...
        'racks.item': {
            ...
            'price_text': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '128', 'blank': 'True'}),
