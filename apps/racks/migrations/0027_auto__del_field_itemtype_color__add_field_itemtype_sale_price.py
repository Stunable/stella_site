...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemType.color'
        db.delete_column('racks_itemtype', 'color_id')

        # Adding field 'ItemType.sale_price'
        db.add_column('racks_itemtype', 'sale_price',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ItemType.color'
        raise RuntimeError("Cannot reverse this migration. 'ItemType.color' and its values cannot be restored.")
        # Deleting field 'ItemType.sale_price'
        db.delete_column('racks_itemtype', 'sale_price')
    ...
    models = {
        ...
        'racks.itemtype': {
            ...
            'SKU': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
            'sale_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
