...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm['racks.Item'].objects.all():
            
            try:
                obj._retailer = RetailerProfile.objects.filter(user=obj.retailers.all()[0])[0]
                print 'set retailer for ',obj, 'to:',obj._retailer
                obj.save()
            except:
                pass
                # print self, 'had no retailer'
