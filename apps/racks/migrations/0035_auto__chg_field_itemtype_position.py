...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.position'
        db.alter_column('racks_itemtype', 'position', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ItemType.position'
        db.alter_column('racks_itemtype', 'position', self.gf('django.db.models.fields.IntegerField')())
