...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.SKU'
        db.alter_column('racks_itemtype', 'SKU', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ItemType.SKU'
        raise RuntimeError("Cannot reverse this migration. 'ItemType.SKU' and its values cannot be restored.")
