...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DailySpecial', fields ['slug']
        db.create_unique('racks_dailyspecial', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'DailySpecial', fields ['slug']
        db.delete_unique('racks_dailyspecial', ['slug'])
