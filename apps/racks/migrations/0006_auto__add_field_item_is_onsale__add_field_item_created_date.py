...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.is_onsale'
        db.add_column('racks_item', 'is_onsale',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Item.created_date'
        db.add_column('racks_item', 'created_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today, auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.is_onsale'
        db.delete_column('racks_item', 'is_onsale')

        # Deleting field 'Item.created_date'
        db.delete_column('racks_item', 'created_date')
