...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VariationHold.user'
        db.delete_column('racks_variationhold', 'user_id')

        # Adding field 'VariationHold.kart'
        db.add_column('racks_variationhold', 'kart',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['kart.Kart']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VariationHold.user'
        raise RuntimeError("Cannot reverse this migration. 'VariationHold.user' and its values cannot be restored.")
        # Deleting field 'VariationHold.kart'
        db.delete_column('racks_variationhold', 'kart_id')
    ...
    models = {
        ...
        'kart.kart': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 1, 0, 0)'}),
        ...
        'racks.dailyspecial': {
            'Items': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['racks.Item']", 'symmetrical': 'False'}),
            'Meta': {'object_name': 'DailySpecial'},
            ...
            'weekday': ('apps.weekday_field.fields.WeekdayField', [], {'max_length': '14', 'null': 'True', 'blank': 'True'})
        },
        ...
        'racks.variationhold': {
            'Meta': {'object_name': 'VariationHold'},
            ...
            'variation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['racks.ItemType']"})
        },
