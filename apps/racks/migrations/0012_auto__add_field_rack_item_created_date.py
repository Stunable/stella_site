...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rack_Item.created_date'
        db.add_column('racks_rack_item', 'created_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today, auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rack_Item.created_date'
        db.delete_column('racks_rack_item', 'created_date')
