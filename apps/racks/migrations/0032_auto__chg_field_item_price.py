...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('racks_item', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Item.price'
        raise RuntimeError("Cannot reverse this migration. 'Item.price' and its values cannot be restored.")
