...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item._retailer'
        db.add_column('racks_item', '_retailer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='retailer_set', null=True, to=orm['retailers.RetailerProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item._retailer'
        db.delete_column('racks_item', '_retailer_id')
    ...
    models = {
        ...
        'racks.item': {
            ...
            '_retailer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retailer_set'", 'null': 'True', 'to': "orm['retailers.RetailerProfile']"}),
