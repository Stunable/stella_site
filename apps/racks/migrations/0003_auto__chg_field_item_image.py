...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Item.image'
        raise RuntimeError("Cannot reverse this migration. 'Item.image' and its values cannot be restored.")
