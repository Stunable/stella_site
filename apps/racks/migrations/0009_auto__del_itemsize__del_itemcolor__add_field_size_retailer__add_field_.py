...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Size.retailer'
        db.add_column('racks_size', 'retailer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Color.retailer'
        db.add_column('racks_color', 'retailer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Size.retailer'
        db.delete_column('racks_size', 'retailer_id')

        # Deleting field 'Color.retailer'
        db.delete_column('racks_color', 'retailer_id')
