...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Color'
        db.create_table('racks_color', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('color_css', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('swatch', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('is_denim', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('racks', ['Color'])

        # Adding model 'DenimColorManager'
        db.create_table('racks_denimcolormanager', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('racks', ['DenimColorManager'])

        # Adding model 'PlainColorManager'
        db.create_table('racks_plaincolormanager', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('racks', ['PlainColorManager'])

        # Deleting field 'Item.retailer'
        db.delete_column('racks_item', 'retailer')

        # Deleting field 'Item.colors'
        db.delete_column('racks_item', 'colors')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('racks_color')

        # Deleting model 'DenimColorManager'
        db.delete_table('racks_denimcolormanager')

        # Deleting model 'PlainColorManager'
        db.delete_table('racks_plaincolormanager')

        # Adding field 'Item.retailer'
        db.add_column('racks_item', 'retailer',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.colors'
        db.add_column('racks_item', 'colors',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'racks.item': {
            ...
            'colors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['racks.Color']", 'symmetrical': 'False'}),
