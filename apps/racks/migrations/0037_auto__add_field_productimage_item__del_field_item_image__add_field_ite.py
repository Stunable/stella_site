...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.item'
        db.add_column('racks_productimage', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_image_set', null=True, to=orm['racks.Item']),
                      keep_default=False)

        # Deleting field 'Item.image'
        # db.delete_column('racks_item', 'image_id')
        db.rename_column('racks_item', 'image_id', 'featured_image_id')

        # Adding field 'Item.featured_image'
        # db.add_column('racks_item', 'featured_image',
        #               self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_featured_image_set', null=True, to=orm['racks.ProductImage']),
        #               keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.item'
        db.delete_column('racks_productimage', 'item_id')

        db.rename_column('racks_item', 'featured_image_id', 'image_id' )
