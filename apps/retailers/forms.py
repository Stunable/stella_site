...
class ItemForm(AjaxModelForm):
    ...
    class Meta:
        model = Item
        exclude = ('fabrics', 'image_urls', 'order', 'retailers', 'tags', 'sizes', 'colors','upload','price','is_onsale','is_available', 'approved','is_deleted','bg_color','api_type','object_id')
...
class ItemEditForm(forms.ModelForm):
    class Meta:
        model = Item
        exclude = ('colors', 'fabrics', 'image_urls', 'order', 'upload', 'is_available', 'price', 'approved','api_type','object_id')
