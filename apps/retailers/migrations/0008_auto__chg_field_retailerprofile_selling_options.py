...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('retailers_retailerprofile', 'selling_options', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'RetailerProfile.selling_options'
        db.alter_column('retailers_retailerprofile', 'selling_options', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'retailers.retailerprofile': {
            ...
            'selling_options': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
