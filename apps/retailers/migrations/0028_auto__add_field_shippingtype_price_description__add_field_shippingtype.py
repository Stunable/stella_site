...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingType.price_description'
        db.add_column('retailers_shippingtype', 'price_description',
                      self.gf('django.db.models.fields.CharField')(default='Free Today Only!', max_length=200),
                      keep_default=False)

        # Adding field 'ShippingType.estimated_price'
        db.add_column('retailers_shippingtype', 'estimated_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'ShippingType.estimated_arrival_time'
        db.add_column('retailers_shippingtype', 'estimated_arrival_time',
                      self.gf('django.db.models.fields.CharField')(default='3-5 days', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingType.price_description'
        db.delete_column('retailers_shippingtype', 'price_description')

        # Deleting field 'ShippingType.estimated_price'
        db.delete_column('retailers_shippingtype', 'estimated_price')

        # Deleting field 'ShippingType.estimated_arrival_time'
        db.delete_column('retailers_shippingtype', 'estimated_arrival_time')
