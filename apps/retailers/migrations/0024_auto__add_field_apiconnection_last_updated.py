...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIConnection.last_updated'
        db.add_column('retailers_apiconnection', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 1, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIConnection.last_updated'
        db.delete_column('retailers_apiconnection', 'last_updated')
