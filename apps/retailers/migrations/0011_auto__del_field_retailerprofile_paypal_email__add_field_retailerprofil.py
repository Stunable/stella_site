...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RetailerProfile.paypal_email'
        db.delete_column('retailers_retailerprofile', 'paypal_email')

        # Adding field 'RetailerProfile.wepay_acct'
        db.add_column('retailers_retailerprofile', 'wepay_acct',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RetailerProfile.paypal_email'
        db.add_column('retailers_retailerprofile', 'paypal_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RetailerProfile.wepay_acct'
        db.delete_column('retailers_retailerprofile', 'wepay_acct')
    ...
    models = {
        ...
        'retailers.retailerprofile': {
            ...
            'wepay_acct': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
