...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RetailerProfile.wepay_acct'
        db.alter_column('retailers_retailerprofile', 'wepay_acct', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'RetailerProfile.wepay_acct'
        db.alter_column('retailers_retailerprofile', 'wepay_acct', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
