...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShopifyConnection'
        db.create_table('retailers_shopifyconnection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('retailer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.RetailerProfile'])),
            ('shop_url', self.gf('django.db.models.fields.TextField')()),
            ('access_token', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('retailers', ['ShopifyConnection'])


    def backwards(self, orm):
        # Deleting model 'ShopifyConnection'
        db.delete_table('retailers_shopifyconnection')
