...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RetailerProfile.slug'
        db.add_column('retailers_retailerprofile', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RetailerProfile.slug'
        db.delete_column('retailers_retailerprofile', 'slug')
    ...
    models = {
        ...
        'racks.itemtype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'item_variation_image_set'", 'null': 'True', 'to': "orm['racks.ProductImage']"}),
        ...
        'racks.productimage': {
            ...
            'retailer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'retailer_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.RetailerProfile']", 'null': 'True', 'blank': 'True'}),
