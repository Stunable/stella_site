...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RetailerProfile.last_name'
        db.delete_column('retailers_retailerprofile', 'last_name')

        # Deleting field 'RetailerProfile.first_name'
        db.delete_column('retailers_retailerprofile', 'first_name')


        # Changing field 'RetailerProfile.name'
        db.alter_column('retailers_retailerprofile', 'name', self.gf('django.db.models.fields.CharField')(default='FIXME', max_length=255))

    def backwards(self, orm):
        # Adding field 'RetailerProfile.last_name'
        db.add_column('retailers_retailerprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RetailerProfile.first_name'
        db.add_column('retailers_retailerprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)
