...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortableConnection.access_token'
        db.add_column('retailers_portableconnection', 'access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortableConnection.access_token'
        db.delete_column('retailers_portableconnection', 'access_token')
