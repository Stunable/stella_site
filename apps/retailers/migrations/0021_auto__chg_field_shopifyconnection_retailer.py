...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShopifyConnection.retailer'
        db.alter_column('retailers_shopifyconnection', 'retailer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'ShopifyConnection.retailer'
        db.alter_column('retailers_shopifyconnection', 'retailer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.RetailerProfile']))
    ...
    models = {
        ...
        'retailers.shopifyconnection': {
            'Meta': {'object_name': 'ShopifyConnection'},
