...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShopifyProduct'
        db.create_table('retailers_shopifyproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('retailers', ['ShopifyProduct'])


    def backwards(self, orm):
        # Deleting model 'ShopifyProduct'
        db.delete_table('retailers_shopifyproduct')
