...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductUpload'
        db.create_table('retailers_productupload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uploaded_zip', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('retailer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.RetailerProfile'])),
            ('processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('retailers', ['ProductUpload'])

        # Adding model 'UploadError'
        db.create_table('retailers_uploaderror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('upload', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.ProductUpload'])),
        ))
        db.send_create_signal('retailers', ['UploadError'])


    def backwards(self, orm):
        # Deleting model 'ProductUpload'
        db.delete_table('retailers_productupload')

        # Deleting model 'UploadError'
        db.delete_table('retailers_uploaderror')
