...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RetailerProfile.phone_number'
        db.alter_column('retailers_retailerprofile', 'phone_number', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'RetailerProfile.city'
        db.alter_column('retailers_retailerprofile', 'city', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'RetailerProfile.selling_options'
        db.alter_column('retailers_retailerprofile', 'selling_options', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'RetailerProfile.company_logo'
        db.alter_column('retailers_retailerprofile', 'company_logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'RetailerProfile.address_2'
        db.alter_column('retailers_retailerprofile', 'address_2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'RetailerProfile.hours'
        db.alter_column('retailers_retailerprofile', 'hours', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'RetailerProfile.state'
        db.alter_column('retailers_retailerprofile', 'state', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'RetailerProfile.address_1'
        db.alter_column('retailers_retailerprofile', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'RetailerProfile.zip_code'
        db.alter_column('retailers_retailerprofile', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'RetailerProfile.phone_number'
        db.alter_column('retailers_retailerprofile', 'phone_number', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(default=-1111, max_length=20))

        # Changing field 'RetailerProfile.city'
        db.alter_column('retailers_retailerprofile', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=150))

        # Changing field 'RetailerProfile.selling_options'
        db.alter_column('retailers_retailerprofile', 'selling_options', self.gf('django.db.models.fields.CharField')(default='none', max_length=100))

        # Changing field 'RetailerProfile.company_logo'
        db.alter_column('retailers_retailerprofile', 'company_logo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'RetailerProfile.address_2'
        db.alter_column('retailers_retailerprofile', 'address_2', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'RetailerProfile.hours'
        db.alter_column('retailers_retailerprofile', 'hours', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'RetailerProfile.state'
        db.alter_column('retailers_retailerprofile', 'state', self.gf('django.db.models.fields.CharField')(default='NY', max_length=150))

        # Changing field 'RetailerProfile.address_1'
        db.alter_column('retailers_retailerprofile', 'address_1', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'RetailerProfile.zip_code'
        db.alter_column('retailers_retailerprofile', 'zip_code', self.gf('django.db.models.fields.CharField')(default=11111, max_length=10))
