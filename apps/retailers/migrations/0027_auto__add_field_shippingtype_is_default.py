...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingType.is_default'
        db.add_column('retailers_shippingtype', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingType.is_default'
        db.delete_column('retailers_shippingtype', 'is_default')
