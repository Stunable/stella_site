...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingType.vendor_tag'
        db.add_column('retailers_shippingtype', 'vendor_tag',
                      self.gf('django.db.models.fields.CharField')(default='FEDEX_GROUND', max_length=64),
                      keep_default=False)

        # Adding field 'ShippingType.vendor'
        db.add_column('retailers_shippingtype', 'vendor',
                      self.gf('django.db.models.fields.CharField')(default='FEDEX', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingType.vendor_tag'
        db.delete_column('retailers_shippingtype', 'vendor_tag')

        # Deleting field 'ShippingType.vendor'
        db.delete_column('retailers_shippingtype', 'vendor')
