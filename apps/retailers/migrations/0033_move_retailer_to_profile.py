...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm['retailers.ShopifyConnection'].objects.all():
            try:
                profile = orm['retailers.RetailerProfile'].objects.get(user=obj.retailer)
                obj.retailer_profile = profile
                obj.save()
            except:
                pass

        for obj in orm['retailers.PortableConnection'].objects.all():
            try:
                profile = orm['retailers.RetailerProfile'].objects.get(user=obj.retailer)
                obj.retailer_profile = profile
                obj.save()
