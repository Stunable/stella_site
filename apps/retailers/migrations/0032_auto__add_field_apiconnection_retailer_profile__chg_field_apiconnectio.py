...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIConnection.retailer_profile'
        db.add_column('retailers_apiconnection', 'retailer_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.RetailerProfile'], null=True),
                      keep_default=False)


        # Changing field 'APIConnection.retailer'
        db.alter_column('retailers_apiconnection', 'retailer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'APIConnection.retailer_profile'
        db.delete_column('retailers_apiconnection', 'retailer_profile_id')


        # User chose to not deal with backwards NULL issues for 'APIConnection.retailer'
        raise RuntimeError("Cannot reverse this migration. 'APIConnection.retailer' and its values cannot be restored.")
    ...
    models = {
        ...
        'retailers.apiconnection': {
            ...
            'retailer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'retailer_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.RetailerProfile']", 'null': 'True'}),
