...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIConnection'
        db.create_table('retailers_apiconnection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('retailer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('update_in_progress', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('retailers', ['APIConnection'])

        # Deleting field 'ShopifyConnection.update_in_progress'
        db.delete_column('retailers_shopifyconnection', 'update_in_progress')

        # Deleting field 'ShopifyConnection.retailer'
        db.delete_column('retailers_shopifyconnection', 'retailer_id')

        # Deleting field 'ShopifyConnection.id'
        db.delete_column('retailers_shopifyconnection', 'id')

        # Adding field 'ShopifyConnection.apiconnection_ptr'
        db.add_column('retailers_shopifyconnection', 'apiconnection_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['retailers.APIConnection'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'APIConnection'
        db.delete_table('retailers_apiconnection')

        # Adding field 'ShopifyConnection.update_in_progress'
        db.add_column('retailers_shopifyconnection', 'update_in_progress',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ShopifyConnection.retailer'
        raise RuntimeError("Cannot reverse this migration. 'ShopifyConnection.retailer' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ShopifyConnection.id'
        raise RuntimeError("Cannot reverse this migration. 'ShopifyConnection.id' and its values cannot be restored.")
        # Deleting field 'ShopifyConnection.apiconnection_ptr'
        db.delete_column('retailers_shopifyconnection', 'apiconnection_ptr_id')
