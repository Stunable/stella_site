...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RetailerProfile.address_1'
        db.delete_column('retailers_retailerprofile', 'address_1')

        # Deleting field 'RetailerProfile.address_2'
        db.delete_column('retailers_retailerprofile', 'address_2')

        # Adding field 'RetailerProfile.address1'
        db.add_column('retailers_retailerprofile', 'address1',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RetailerProfile.address2'
        db.add_column('retailers_retailerprofile', 'address2',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RetailerProfile.address_1'
        db.add_column('retailers_retailerprofile', 'address_1',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RetailerProfile.address_2'
        db.add_column('retailers_retailerprofile', 'address_2',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RetailerProfile.address1'
        db.delete_column('retailers_retailerprofile', 'address1')

        # Deleting field 'RetailerProfile.address2'
        db.delete_column('retailers_retailerprofile', 'address2')
