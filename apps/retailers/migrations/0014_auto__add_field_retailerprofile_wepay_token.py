...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RetailerProfile.wepay_token'
        db.add_column('retailers_retailerprofile', 'wepay_token',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RetailerProfile.wepay_token'
        db.delete_column('retailers_retailerprofile', 'wepay_token')
