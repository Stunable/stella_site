...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShopifyVariation.api_connection'
        db.add_column('retailers_shopifyvariation', 'api_connection',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['retailers.APIConnection']),
                      keep_default=False)

        # Adding field 'ShopifyProduct.api_connection'
        db.add_column('retailers_shopifyproduct', 'api_connection',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['retailers.APIConnection']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShopifyVariation.api_connection'
        db.delete_column('retailers_shopifyvariation', 'api_connection_id')

        # Deleting field 'ShopifyProduct.api_connection'
        db.delete_column('retailers_shopifyproduct', 'api_connection_id')
