...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PortableConnection'
        db.create_table('retailers_portableconnection', (
            ('apiconnection_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['retailers.APIConnection'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('retailers', ['PortableConnection'])

        # Adding model 'PortableVariation'
        db.create_table('retailers_portablevariation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_id', self.gf('django.db.models.fields.IntegerField')()),
            ('api_connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.APIConnection'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.PortableVariation'], null=True, blank=True)),
        ))
        db.send_create_signal('retailers', ['PortableVariation'])

        # Adding model 'PortableProduct'
        db.create_table('retailers_portableproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_id', self.gf('django.db.models.fields.IntegerField')()),
            ('api_connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.APIConnection'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.PortableProduct'], null=True, blank=True)),
        ))
        db.send_create_signal('retailers', ['PortableProduct'])

        # Adding field 'ShopifyVariation.parent'
        db.add_column('retailers_shopifyvariation', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.ShopifyVariation'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopifyProduct.parent'
        db.add_column('retailers_shopifyproduct', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['retailers.ShopifyProduct'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PortableConnection'
        db.delete_table('retailers_portableconnection')

        # Deleting model 'PortableVariation'
        db.delete_table('retailers_portablevariation')

        # Deleting model 'PortableProduct'
        db.delete_table('retailers_portableproduct')

        # Deleting field 'ShopifyVariation.parent'
        db.delete_column('retailers_shopifyvariation', 'parent_id')

        # Deleting field 'ShopifyProduct.parent'
        db.delete_column('retailers_shopifyproduct', 'parent_id')
    ...
    models = {
        ...
        'retailers.apiconnection': {
            'Meta': {'object_name': 'APIConnection'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'retailer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'update_in_progress': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'retailers.portableconnection': {
            'Meta': {'object_name': 'PortableConnection', '_ormbases': ['retailers.APIConnection']},
            'apiconnection_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['retailers.APIConnection']", 'unique': 'True', 'primary_key': 'True'})
        },
        'retailers.portableproduct': {
            'Meta': {'object_name': 'PortableProduct'},
            'api_connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.APIConnection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.PortableProduct']", 'null': 'True', 'blank': 'True'}),
            'source_id': ('django.db.models.fields.IntegerField', [], {})
        },
        'retailers.portablevariation': {
            'Meta': {'object_name': 'PortableVariation'},
            'api_connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.APIConnection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.PortableVariation']", 'null': 'True', 'blank': 'True'}),
            'source_id': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        'retailers.shopifyconnection': {
            'Meta': {'object_name': 'ShopifyConnection', '_ormbases': ['retailers.APIConnection']},
            'access_token': ('django.db.models.fields.TextField', [], {}),
            'apiconnection_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['retailers.APIConnection']", 'unique': 'True', 'primary_key': 'True'}),
            'shop_url': ('django.db.models.fields.TextField', [], {})
        },
        'retailers.shopifyproduct': {
            'Meta': {'object_name': 'ShopifyProduct'},
            'api_connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.APIConnection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.ShopifyProduct']", 'null': 'True', 'blank': 'True'}),
            'source_id': ('django.db.models.fields.IntegerField', [], {})
        },
        'retailers.shopifyvariation': {
            ...
            'api_connection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.APIConnection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['retailers.ShopifyVariation']", 'null': 'True', 'blank': 'True'}),
            'source_id': ('django.db.models.fields.IntegerField', [], {})
        },
