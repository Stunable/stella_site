...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RetailerProfile.retailer_name'
        db.delete_column('retailers_retailerprofile', 'retailer_name')

        # Deleting field 'RetailerProfile.password'
        db.delete_column('retailers_retailerprofile', 'password')

        # Adding field 'RetailerProfile.name'
        db.add_column('retailers_retailerprofile', 'name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'RetailerProfile.retailer_name'
        raise RuntimeError("Cannot reverse this migration. 'RetailerProfile.retailer_name' and its values cannot be restored.")
        # Adding field 'RetailerProfile.password'
        db.add_column('retailers_retailerprofile', 'password',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RetailerProfile.name'
        db.delete_column('retailers_retailerprofile', 'name')
