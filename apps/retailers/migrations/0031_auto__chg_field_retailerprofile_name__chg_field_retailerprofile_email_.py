...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RetailerProfile.name'
        db.alter_column('retailers_retailerprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'RetailerProfile.email_address'
        db.alter_column('retailers_retailerprofile', 'email_address', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'RetailerProfile.description'
        db.alter_column('retailers_retailerprofile', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'RetailerProfile.name'
        db.alter_column('retailers_retailerprofile', 'name', self.gf('django.db.models.fields.CharField')(default='nameless', max_length=255))

        # Changing field 'RetailerProfile.email_address'
        db.alter_column('retailers_retailerprofile', 'email_address', self.gf('django.db.models.fields.EmailField')(default='gdamon@gmail.com', max_length=75))

        # Changing field 'RetailerProfile.description'
        db.alter_column('retailers_retailerprofile', 'description', self.gf('django.db.models.fields.TextField')(default='no description'))
    ...
    models = {
        ...
        'retailers.retailerprofile': {
            ...
            'email_address': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
