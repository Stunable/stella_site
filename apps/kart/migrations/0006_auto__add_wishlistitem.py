...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kart_wishlistitem', (
            ...
            ('picture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['racks.ProductImage'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('kart', ['WishListItem'])


    def backwards(self, orm):
        # Deleting model 'WishListItem'
        db.delete_table('kart_wishlistitem')
