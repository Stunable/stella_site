...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kart.user'
        db.add_column('kart_kart', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kart.user'
        db.delete_column('kart_kart', 'user_id')
    ...
    models = {
        ...
        'kart.kart': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 0, 0)'}),
