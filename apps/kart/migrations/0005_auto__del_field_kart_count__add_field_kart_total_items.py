...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Kart.count'
        db.delete_column('kart_kart', 'count')

        # Adding field 'Kart.total_items'
        db.add_column('kart_kart', 'total_items',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Kart.count'
        db.add_column('kart_kart', 'count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Kart.total_items'
        db.delete_column('kart_kart', 'total_items')
