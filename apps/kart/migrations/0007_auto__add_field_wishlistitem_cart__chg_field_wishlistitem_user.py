...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WishListItem.cart'
        db.add_column('kart_wishlistitem', 'cart',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kart.Kart'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'WishListItem.user'
        db.alter_column('kart_wishlistitem', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'WishListItem.cart'
        db.delete_column('kart_wishlistitem', 'cart_id')


        # User chose to not deal with backwards NULL issues for 'WishListItem.user'
        raise RuntimeError("Cannot reverse this migration. 'WishListItem.user' and its values cannot be restored.")
    ...
    models = {
        ...
        'kart.wishlistitem': {
            ...
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kart.Kart']", 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['racks.Item']"}),
            'item_variation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['racks.ItemType']"}),
            'picture': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['racks.ProductImage']"}),
