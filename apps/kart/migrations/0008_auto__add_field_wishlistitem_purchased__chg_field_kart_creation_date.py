...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WishListItem.purchased'
        db.add_column('kart_wishlistitem', 'purchased',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Kart.creation_date'
        db.alter_column('kart_kart', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'WishListItem.purchased'
        db.delete_column('kart_wishlistitem', 'purchased')


        # Changing field 'Kart.creation_date'
        db.alter_column('kart_kart', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
