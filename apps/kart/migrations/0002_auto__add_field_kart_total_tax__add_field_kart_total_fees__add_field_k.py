...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kart.total_tax'
        db.add_column('kart_kart', 'total_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Kart.total_fees'
        db.add_column('kart_kart', 'total_fees',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Kart.total_shipping'
        db.add_column('kart_kart', 'total_shipping',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kart.total_tax'
        db.delete_column('kart_kart', 'total_tax')

        # Deleting field 'Kart.total_fees'
        db.delete_column('kart_kart', 'total_fees')

        # Deleting field 'Kart.total_shipping'
        db.delete_column('kart_kart', 'total_shipping')
