...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Address.line2'
        db.delete_column('accounts_address', 'line2')

        # Deleting field 'Address.line1'
        db.delete_column('accounts_address', 'line1')

        # Adding field 'Address.address1'
        db.add_column('accounts_address', 'address1',
                      self.gf('django.db.models.fields.CharField')(default='home', max_length=100),
                      keep_default=False)

        # Adding field 'Address.address2'
        db.add_column('accounts_address', 'address2',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Address.line2'
        db.add_column('accounts_address', 'line2',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Address.line1'
        raise RuntimeError("Cannot reverse this migration. 'Address.line1' and its values cannot be restored.")
        # Deleting field 'Address.address1'
        db.delete_column('accounts_address', 'address1')

        # Deleting field 'Address.address2'
        db.delete_column('accounts_address', 'address2')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 16, 50, 40, 3)'}),
