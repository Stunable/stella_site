...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CCToken', fields ['token']
        db.create_unique('accounts_cctoken', ['token'])

        # Adding unique constraint on 'CCToken', fields ['user', 'cc_name']
        db.create_unique('accounts_cctoken', ['user_id', 'cc_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'CCToken', fields ['user', 'cc_name']
        db.delete_unique('accounts_cctoken', ['user_id', 'cc_name'])

        # Removing unique constraint on 'CCToken', fields ['token']
        db.delete_unique('accounts_cctoken', ['token'])
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 17, 11, 43, 40, 2)'}),
