...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'first_login',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'first_login')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 31, 5, 59, 5, 4)'}),
