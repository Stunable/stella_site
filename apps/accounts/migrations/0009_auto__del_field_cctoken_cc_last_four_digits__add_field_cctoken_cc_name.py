...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CCToken.cc_last_four_digits'
        db.delete_column('accounts_cctoken', 'cc_last_four_digits')

        # Adding field 'CCToken.cc_name'
        db.add_column('accounts_cctoken', 'cc_name',
                      self.gf('django.db.models.fields.CharField')(default='xxxxx1234', max_length=32),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CCToken.cc_last_four_digits'
        raise RuntimeError("Cannot reverse this migration. 'CCToken.cc_last_four_digits' and its values cannot be restored.")
        # Deleting field 'CCToken.cc_name'
        db.delete_column('accounts_cctoken', 'cc_name')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 19, 28, 56)'}),
