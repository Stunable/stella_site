...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.line1'
        db.alter_column('accounts_address', 'line1', self.gf('django.db.models.fields.CharField')(default='NA', max_length=100))
        # Adding field 'UserProfile.default_cc'
        db.add_column('accounts_userprofile', 'default_cc',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Address.line1'
        db.alter_column('accounts_address', 'line1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Deleting field 'UserProfile.default_cc'
        db.delete_column('accounts_userprofile', 'default_cc')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 29, 0, 32, 57, 2)'}),
