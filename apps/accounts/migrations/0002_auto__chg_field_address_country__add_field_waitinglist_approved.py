...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_address', 'country', self.gf('django.db.models.fields.CharField')(max_length=250))
        # Adding field 'WaitingList.approved'
        db.add_column('accounts_waitinglist', 'approved',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Address.country'
        db.alter_column('accounts_address', 'country', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
        # Deleting field 'WaitingList.approved'
        db.delete_column('accounts_waitinglist', 'approved')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 1, 23, 23, 54, 2)'}),
