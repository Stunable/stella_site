...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CCToken.card_holder_name'
        db.delete_column('accounts_cctoken', 'card_holder_name')

        # Adding field 'CCToken.first_name'
        db.add_column('accounts_cctoken', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='NA', max_length=100),
                      keep_default=False)

        # Adding field 'CCToken.last_name'
        db.add_column('accounts_cctoken', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='NA', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CCToken.card_holder_name'
        db.add_column('accounts_cctoken', 'card_holder_name',
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 29, 6, 50, 17, 2)'}),
