...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'anonymousProfile'
        db.create_table('accounts_anonymousprofile', (
        ...
        db.send_create_signal('accounts', ['anonymousProfile'])


    def backwards(self, orm):
        # Deleting model 'anonymousProfile'
        db.delete_table('accounts_anonymousprofile')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 2, 14, 2, 38, 4)'}),
