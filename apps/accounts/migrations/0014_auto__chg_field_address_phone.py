...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.phone'
        db.alter_column('accounts_address', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Address.phone'
        db.alter_column('accounts_address', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 11, 39, 39, 1)'}),
