...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CCToken.first_name'
        db.delete_column('accounts_cctoken', 'first_name')

        # Deleting field 'CCToken.last_name'
        db.delete_column('accounts_cctoken', 'last_name')

        # Adding field 'CCToken.user_name'
        db.add_column('accounts_cctoken', 'user_name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CCToken.first_name'
        raise RuntimeError("Cannot reverse this migration. 'CCToken.first_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CCToken.last_name'
        raise RuntimeError("Cannot reverse this migration. 'CCToken.last_name' and its values cannot be restored.")
        # Deleting field 'CCToken.user_name'
        db.delete_column('accounts_cctoken', 'user_name')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 19, 33, 38)'}),
