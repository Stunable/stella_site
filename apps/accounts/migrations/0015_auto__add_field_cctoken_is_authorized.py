...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CCToken.is_authorized'
        db.add_column('accounts_cctoken', 'is_authorized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CCToken.is_authorized'
        db.delete_column('accounts_cctoken', 'is_authorized')
    ...
    models = {
        ...
        'accounts.waitinglist': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 18, 6, 43, 1)'}),
