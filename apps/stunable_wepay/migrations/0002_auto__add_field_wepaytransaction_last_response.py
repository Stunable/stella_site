...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WePayTransaction.last_response'
        db.add_column('stunable_wepay_wepaytransaction', 'last_response',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WePayTransaction.last_response'
        db.delete_column('stunable_wepay_wepaytransaction', 'last_response')
