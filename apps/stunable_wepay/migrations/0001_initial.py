...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WePayTransaction'
        db.create_table('stunable_wepay_wepaytransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('checkout_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.send_create_signal('stunable_wepay', ['WePayTransaction'])


    def backwards(self, orm):
        # Deleting model 'WePayTransaction'
        db.delete_table('stunable_wepay_wepaytransaction')
