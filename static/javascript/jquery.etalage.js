...
;(function($){
	$.fn.etalage = function(options){
		...
		var o = $.extend({
			...
			zoom_area_height: 600,		// Height of the zoomed image frame (including borders, padding) (value in pixels / 'justify' = height of large thumb + small thumbs)
			...
			smallthumb_select_on_hover: true,	// This will scroll through the small thumbnails when hovering them, instead of clicking them (true/false)
			smallthumbs_position: 'left',		// Where to position the row of small thumbnails ('bottom' / 'left' / 'right')
